<!-- filepath: d:\KopiTrack\resources\views\admin\finance\show.blade.php -->
<x-app-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Data Keuangan Tanggal {{ \Carbon\Carbon::parse($finance->finance_date)->format('d M Y') }}</h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-500">Tanggal</h4>
                                <p class="text-base">{{ \Carbon\Carbon::parse($finance->finance_date)->format('d M Y') }}</p>
                            </div>
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <p class="text-base text-green-600 font-semibold">Rp {{ number_format($finance->income_balance, 0, ',', '.') }}</p>
                            </div>

                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-500">Pengeluaran</h4>
                                <p class="text-base text-red-600 font-semibold">Rp {{ number_format($finance->expenditure_balance, 0, ',', '.') }}</p>
                            </div>

                            <div>
                                <h4 class="text-sm font-medium text-gray-500">Laba/Rugi</h4>
                                <p class="text-lg {{ $finance->income_balance - $finance->expenditure_balance >= 0 ? 'text-green-600' : 'text-red-600' }} font-bold">
                ...
                <div class="border-t border-gray-200 px-6 py-4 bg-gray-50 flex justify-between">
                    <a href="{{ route('admin.finance.edit', $finance->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300">
