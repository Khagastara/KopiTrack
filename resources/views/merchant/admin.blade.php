...
@section('header', 'Merchant Dashboard')
...
<div class="bg-white shadow rounded-lg p-4 mt-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <div>
            <select class="text-sm border-gray-300 rounded-md shadow-sm focus:border-brown-300 focus:ring focus:ring-brown-200 focus:ring-opacity-50">
